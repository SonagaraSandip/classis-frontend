...
const Dashboard = () => {
  ...
  const handleCustomSubjectChange = useCallback((studentId, val) => {
  ...
  const handleCustomTotalChange = useCallback((studentId, val) => {
                ...
                {students.map((student, index) => {
                  ...
                  return (
                    <StudentMarkRow
                      ...
                      subject={subject}
                      subjectsList={subjectsByStandard[standard] || []}
                      customSubject={subjectByStudent[student._id] || ""}
                      customTotal={totalMarksByStudent[student._id] || ""}
